...
function loadSignInOut() {
  ...
  sendPost("/manager_getroles", JSON.stringify(request), function(response) {
    ...
    sendPost("/manager_signinout", JSON.stringify(request), function(response) {
      ...
      nameH.setAttribute('style', 'font-size:15px; text-align: left; vertical-align: middle; height: 30px; width: 120px; padding: 3px;');

      var startH = document.createElement('th');
      startH.innerText = 'Start';
      startH.setAttribute('style', 'font-size:15px; text-align: center; vertical-align: middle; height: 30px; width: 70px; padding: 3px;');

      var finishH = document.createElement('th');
      finishH.innerText = 'Finish';
      finishH.setAttribute('style', 'font-size:15px; text-align: center; vertical-align: middle; height: 30px; width: 70px; padding: 3px;');
      ...
      for(var i=0; i < response.length; i++) {
        ...
        name.setAttribute('style', 'font-size:15px; text-align: left; vertical-align: middle; height: 30px; width: 120px; padding: 3px; background: ' + roleBg + '; color: ' + roleTxt + ';');
        ...
        start.setAttribute('style', 'font-size:15px; text-align: center; vertical-align: middle; height: 30px; width: 70px; padding: 3px;');
        ...
        finish.setAttribute('style', 'font-size:15px; text-align: center; vertical-align: middle; height: 30px; width: 70px; padding: 3px;');
